                ...
                <div class="col-xl-4 col-lg-5 col-md-7 mx-auto">
                        <div class="card z-index-0">
                            <div class="card-header text-center pt-4">
                                <p>Introduce tu correo electrónico institucional para recuperar tu contraseña</p>
                            ...
                            <div class="card-body pt-1">
                                <form class="form-horizontal" id="email_form_recovery_pass" action="/Register/verifyCodePass" method="POST">
                                    ...
                                    <div class="form-group text-center">
                                        <button class="btn btn-outline-danger w-100 my-4 mb-0 ms-auto" type="submit" id="btn_registro_email">Verificar</button>
                                    </div>
